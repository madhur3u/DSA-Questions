...
public:
    int singleNonDuplicate(vector<int>& nums) {
        ...
        // hi = n - 2 as check fo that condition when last element is single, low should not cross the array
        // not needed for 0 as xor of 0 and 1 is 1
        int lo = 0, hi = n - 2;
        ...
        while (lo <= hi){
            ...
            // rather than checking using if we can do xor of mid and 1
            // if mid is odd, mid^1 will be previous even ex. mid = 5 -->101 ^ 1 --> 100 --> 4
            // if mid is even, mid^1 will ve next odd     ex. mid = 4 -->100 ^ 1 --> 101 --> 5
            // this same thing we are doing inside commented if statement
